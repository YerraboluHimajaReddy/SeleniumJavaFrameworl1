...
public class ElementLocatorsInSeleniumPartialLinkTextMethod {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement signup_Button_linktext = driver.findElement(By.partialLinkText("Sign"));

		System.out.println("signup type attrtibute text  is :"+ signup_Button_linktext.getAttribute("type"));
		
		signup_Button_linktext.click();
