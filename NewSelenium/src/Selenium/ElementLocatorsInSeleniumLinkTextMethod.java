...
public class ElementLocatorsInSeleniumLinkTextMethod {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement signup_Button_linktext = driver.findElement(By.linkText("Sign Up"));

		System.out.println(" link text type is : "+signup_Button_linktext.getAttribute("type"));
