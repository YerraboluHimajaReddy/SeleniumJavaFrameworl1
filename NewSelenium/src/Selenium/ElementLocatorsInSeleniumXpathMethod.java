...
public class ElementLocatorsInSeleniumXpathMethod {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Aboslute xpath exanple : //*[@id="u_0_k_Nv"]/i[1]
		// Relative xpath : //*[contains(@class,'_5dbc img sp_98fCI7IVTTz
		// sx_54513f')][1]
		// Absolute xpath will not waor as expected it will fail due to dynamic changes
		// of a webpage, that's y we are using Relative xpath
		// driver.findElement(By.xpath("//*[@id=\"u_0_l_ZI\"]")).clear();
