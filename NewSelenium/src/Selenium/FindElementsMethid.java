...
public class FindElementsMethid {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> listofelements= driver.findElements(By.cssSelector("input[type=\"text\"]"));

		System.out.println(" no of elements is there in  listofelements list is : "+listofelements.size());
...
// Output:
//no of elements is there in  listofelements list is : 6
//text
//text
//text
//text
